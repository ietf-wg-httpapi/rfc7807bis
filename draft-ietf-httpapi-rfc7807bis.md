...
* "title" (string) - A short, human-readable summary of the problem type. It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization (e.g., using proactive content negotiation; see {{I-D.ietf-httpbis-semantics, Section 12.1}}).

* "status" (number) - The HTTP status code ({{I-D.ietf-httpbis-semantics, Section 15}}) generated by the origin server for this occurrence of the problem.
